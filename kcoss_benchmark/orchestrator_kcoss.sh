...
# Orchestrator script to run multiple Slurm jobs (kcoss_benchmark_single.sh)
...
SLURM_SCRIPT="kcoss_benchmark_single.sh"
RESULTS_DIR="./results"
WORKING_DIR="/scratch/kap6605/kcoss_bench"
...
PARAMS="FINETUNED"  # or e.g. "default"
